...
GRID_SIZE = 20
GRID_WIDTH = SCREEN_WIDHT / GRID_SIZE
...
class Snake():
    ...
    def create(self):
        self.length = 2
        self.positions = [(int(SCREEN_WIDHT/2),int(SCREEN_HEIGHT/2))]
    ...
    def move(self):
        ...
        elif new[0] < 0 or new[0] >=SCREEN_WIDHT or new[1] < 0 or new[1] >= SCREEN_HEIGHT:
            sleep(1)
            self.create()
        else:
