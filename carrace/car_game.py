...
class Car():
    def __init__(self, x=0, y=0, dx=0, dy=0):
        ...
        car_images_path = resource_path('carrace/assets/car')
        ...
        crash_image_path = resource_path('carrace/assets/crash.png')
        crash_sound_path = resource_path('carrace/assets/crash.wav')
        collision_sound_path = resource_path('carrace/assets/collision.wav')
        engine_sound_path = resource_path('carrace/assets/engine.wav')
...
class Game():
    def __init__(self):
        # 게임 리소스 로드
        menu_image_path = resource_path('carrace/assets/menu_car.png')
        self.image_intro = pygame.image.load(menu_image_path)
        pygame.mixer.music.load(resource_path('carrace/assets/race.wav'))
        font_path = resource_path('carrace/assets/NanumGothicCoding-Bold.ttf')
